...
export async function trainWalletDecisionProfile(input: {
  ...
  if (
    ...
    const refreshedProfile = {
      ...
      summary: `${active.summary} Scalp profile migrated to the audited recent-performance baseline with corrected reward/risk exits; prior outcomes remain auditable and Smart profile settings were preserved.`,
    } satisfies DecisionLearningProfile;
